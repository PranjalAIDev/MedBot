...
import { User, Bell, Lock, Globe, Heart } from "lucide-react";
import { DashboardLayout } from "../../componenets/doctor/DashboardLayout";
import DoctorProfile from "../../componenets/doctor/DoctorProfile";
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
          <div className="grid divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <SettingSection
              ...
              description="Update your specialty and chat availability"
            >
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                You can update your specialty and chat availability in the profile section above.
              </p>
            </SettingSection>
